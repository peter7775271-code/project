        ...
        <div className="w-full max-w-md">
          ...
          <div className="glass-card rounded-[2.5rem] p-10 md:p-12">
            ...
            <div className="mt-10 pt-8 border-t border-neutral-50 text-center space-y-4">
              <p className="text-xs text-neutral-400 font-medium">New to the platform?</p>
              <Link href="/signup" className="w-full py-4 bg-white border border-neutral-100 rounded-2xl text-[10px] font-bold uppercase tracking-[0.2em] text-neutral-900 hover:border-primary hover:text-primary transition-all flex items-center justify-center space-x-2 shadow-sm">
                <UserPlus size={14} />
